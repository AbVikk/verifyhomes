<x-guest-layout>
    <form wire:submit="register" class="space-y-4">
        <div class="space-y-2 text-center">
            <h1 class="text-2xl font-semibold text-gray-900">Tenant registration</h1>
            <p class="text-sm text-gray-600">
                Create your tenant account to start exploring trusted rentals on VerifyHomes.
            </p>
        </div>
        ...
        <div class="flex items-center justify-between pt-2">
            ...
            <x-primary-button wire:loading.attr="disabled" wire:target="register">
                <span wire:loading.remove wire:target="register">Create Tenant Account</span>

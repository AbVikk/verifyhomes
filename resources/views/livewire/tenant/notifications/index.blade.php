    ...
    <div class="admin-page-inner space-y-6">
        ...
        @elseif ($notifications->isEmpty())
            <x-admin.empty-state
                ...
                copy="We will notify you here when payments, complaints, or move-out updates are logged."
            >
                <a href="{{ route('tenant.occupancy.index') }}" class="admin-inline-link mt-3 inline-flex">View My Stays</a>
            </x-admin.empty-state>
        @else
            <div class="space-y-4">

            ...
            <x-admin.panel>
                <div class="space-y-5">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-600">Contact VerifyHomes Support if you need help with your account, verification, inspection, payment, rent, purchase, maintenance, or another issue.</p>
                        <a href="{{ route('tenant.support.create') }}" class="admin-button admin-button-primary mt-4 inline-flex">Contact Support</a>
                    </div>
                </div>
            </x-admin.panel>
        </div>

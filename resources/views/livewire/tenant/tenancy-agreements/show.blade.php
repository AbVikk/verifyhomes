    ...
    <div class="admin-page-inner space-y-6">
        ...
        <x-admin.panel>
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div><p class="admin-eyebrow">Tenancy agreement</p><h2 class="admin-panel-title">Your rental agreement</h2><p class="admin-panel-copy">Review the rent details and practical terms recorded when your rent payment was confirmed.</p></div>
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
            ...
            <x-admin.panel>
                <div class="space-y-4">
                    ...
                    @elseif ($agreement->tenant_accepted_at)
                        <x-status-chip tone="info">Awaiting landlord</x-status-chip><p class="text-sm text-slate-600">You accepted on {{ $agreement->tenant_accepted_at->format('M j, Y g:i A') }}. The landlord will review next.</p>
                    @else
                        <x-status-chip tone="warning">Awaiting your acceptance</x-status-chip>
